...
modo_alarma_loop:
    ...
    cmp al, 'c' ; configurar alarma
    je configurar_alarma

    cmp al, 'd' ; desactivar alarma
...
install_alarm_handler:
    ...
    mov ax, [es:0128h] ; acceder y guardar en ax
	mov [old_4a_offset], ax ; preservar offset viejo

	mov ax, [es:012Ah] ; acceder y guardar en ax
...
; alarma
alarm_welcome_msg: db 'C = Configurar Alarma, D = Desactivar Alarma', 0x0D, 0x0A, 0
alarma_ocurrio_msg: db 'Alarma Ocurrio!', 0x0D, 0x0A, 0
